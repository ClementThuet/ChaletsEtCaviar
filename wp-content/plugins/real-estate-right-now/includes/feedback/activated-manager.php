<?php Namespace RealEstatePlugin_activate{
    if( is_multisite())
       return;
...
if ( __NAMESPACE__ == 'CarDealerPlugin_activate')
    {
     $BILLPRODUCT = 'CARDEALERPLUGIN' ;
     $BILLPRODUCTNAME = 'Car Dealer Plugin';
     $BILLPRODUCTSLANGUAGE = 'cardealer' ; 
     $BILLPRODUCTPAGE = 'cardealer_settings' ;
     $BILLCLASS = 'ACTIVATED_'.$BILLPRODUCT;
     $BILL_OPTIN = strtolower($BILLPRODUCT).'_optin'; 
     $PRODUCT_URL = CARDEALERURL; 
     $PRODUCTVERSION = CARDEALERVERSION; 
 } 
...
if ( __NAMESPACE__ == 'RealEstatePlugin_activate')
    { 
     $BILLPRODUCT = 'REALESTATEPLUGIN' ;
     $BILLPRODUCTNAME = 'Real Estate Plugin';
     $BILLPRODUCTSLANGUAGE = 'real-estate-right-now' ; 
     $BILLPRODUCTPAGE = 'rep_settings' ;
     $BILLCLASS = 'ACTIVATED_'.$BILLPRODUCT;
     $BILL_OPTIN = strtolower($BILLPRODUCT).'_optin'; 
     $PRODUCT_URL = REALESTATEURL;
     $PRODUCTVERSION = REALESTATEVERSION; 
}
if( isset( $_GET[ 'page' ] ) ) 
    {
              ...
              <div class="bill-vote-gravatar"><a href="http://profiles.wordpress.org/sminozzi" target="_blank"><img src="https://en.gravatar.com/userimage/94727241/31b8438335a13018a1f52661de469b60.jpg?size=100" alt="Bill Minozzi" width="70" height="70"></a></div>
		    	<div class="bill-vote-message">
                 ...
                 <br /><br /> 			
                        ...
                        <input type="hidden" id="version" name="version" value="<?php echo $PRODUCTVERSION;?>" />
