...
$ah_help .=  " " . __("You can set automatic updates for plugins and themes and disable all the xml-rpc API (or only Pingback) and Json WordPress Rest API in that tab and others usefull options to increase the site security. We suggest check yes for all.", "antihacker");

$ah_help .= '<br>';
$ah_help .= '<br>';

$ah_help .=  "2) ". __("Whitelist Tab: Open and add your IP address to the whitelist field (if necessary) and click save changes. You can see your current  IP address at that page.", "antihacker");

$ah_help .= '<br>';
$ah_help .= '<br>';

$ah_help .=  "3) ". __("eMail Settings Tab: The email alert will be send to your wordpress user email. You can change this email by click over the tab email settings at the plugin management page.", "antihacker");


$ah_help .= '<br>';
$ah_help .= '<br>';

$ah_help .=  "4) ". __("Notification Sectings Tab: Update your's Email Alerts. (Alerts about failed logins, succesfull logins and firewall blocks)", "antihacker");
...
$ah_help .=  __("To avoid receive the alert email, just add your IP to whitelist. Please, read above (4).", "antihacker" );
